...
public class MaskWithGlasses extends ArmorItem {
    String g_name;
    String g_tooltip;

    public MaskWithGlasses(String name, String tooltip, IArmorMaterial mat, EquipmentSlotType slot, Properties props) {
